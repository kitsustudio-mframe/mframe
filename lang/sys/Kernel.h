...
#include "mframe/lang/sys/Timer.h"
 ...
 */
struct mframe::lang::sys::Kernel : public virtual mframe::lang::Interface {
  /* **************************************************************************
   * Method
   */
   ...
   * @param task 工作事件。
   * @return null 建立失敗。
   * @return mframe::lang::sys::Thread 建立成功。
   */
  virtual mframe::lang::sys::Thread* allocThread(mframe::lang::func::Runnable& task, mframe::lang::Data& stackMemory) abstract;
   ...
   * @return mframe::lang::sys::Thread 建立成功。
   */
  virtual mframe::lang::sys::Thread* allocThread(mframe::lang::func::Runnable& task, int stackSize) abstract;
   ...
   * @return Thread 獲取成功。
   */
  virtual mframe::lang::sys::Thread* getCurrentThread(void) abstract;
   ...
   */
  virtual mframe::lang::sys::Timer* allocTimer(void) abstract;
